...
function load_tynyMce_full(cntrol, height) {
...
function load_tynyMce_simple(cntrol, height) {
    let h = cntrol.dataset.height;
...
function load_TynyMCE_controls(root_obj) {
    
    root_obj.querySelectorAll('textarea.richtext').forEach(cntrol => {
        load_tynyMce_full(cntrol, 500);
    });
    root_obj.querySelectorAll('textarea.richtext_simple').forEach(cntrol => {
        load_tynyMce_simple(cntrol, 200);
    });
}
...
*/
    load_TynyMCE_controls(document);
