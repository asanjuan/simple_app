/**
 *  convierte la aplicación en PWA y gestiona el historial de navegación por pestaña
 * */
...
window.addEventListener("load", () => {
    ...
    //aprovechamos para asociar el evento de cambiar de compañía al selector de empresas
    const companySelector = document.getElementById("company_selector");
    if (companySelector) {
        companySelector.addEventListener("change", (e) => {
            switch_company(e.target.value);
        });
    }
});
