...
function print_lookup_field($campo, $tabla, $campo_codigo, $campo_descripcion, $valor_actual, $descripcion_actual, $controller , $required)
{
	ob_start();
...
function print_grid($view_id, $data_field, $data_value, $grid_id)
{
	ob_start();
	if ($grid_id == ""){
