...
<body>
    ...
    <div class="login-main">
        <div class="login-container">
            <div style="text-align:center"><h1 ><?php echo get_config('APP_NAME'); ?></h1></div>
            <div class="login-box">
                ...
                <form action="" method="POST">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" id="password" name="password" value="<?php echo $password; ?>" autocomplete="off" required>
                    </div>
                    <div class="input-group">
